...
export const GET_MESSAAGE_BY_ID_REQUEST = "GET_MESSAGE_BY_ID_REQUEST";
export const GET_MESSAAGE_BY_ID_SUCCESS = "GET_MESSAGE_BY_ID_SUCCESS";
export const GET_MESSAAGE_BY_ID_FAILURE = "GET_MESSAGE_BY_ID_FAILURE";
